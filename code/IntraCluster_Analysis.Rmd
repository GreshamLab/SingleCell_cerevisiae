...
## Plot genes with the highest ranks - so most variable

```{r, fig.height=60, fig.width=7}
genes_to_plot <- as.character(rank_combine$genes)[1:20]
...
## Do box plot of gene counts for these genes

```{r, fig.height=64, fig.width=7}
df %>%
...
# Have some high variability genes next to some low variability genes
