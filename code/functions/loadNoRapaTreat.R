#Since I load many times the RAPA dataset before tratment in which i only
#retain the wt strain, and since I do many transformations on it, I decided
#to write a function to do it
loadNoRapaTreat <- function(rawdata_path = NULL, metadata_path = NULL) {
